...
typedef enum {
	 ...
	 * version is from the "from" list. If the "from" status is UNMODIFIED, the
	 * item status will the "onto" one, otherwise it will be the "from" one.
	 */
	 ...
	 * "onto" list. If an item appears in both lists, then it will be "merged"
	 * to appear as if the old version was from the "onto" list and the new
	 * version is from the "from" list. If the "onto" status is UNMODIFIED, the
	 * item status will the "from" one, otherwise it will be the "onto" one, except:
